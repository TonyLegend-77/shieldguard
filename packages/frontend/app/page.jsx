...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-paper">
      ...
      {/* Live threat feed teaser — real data only, no simulated mode.
          Shares ThreatFeed.jsx with the full /threats page so both surfaces
          fetch the same 250-deep history and stay in sync. */}
      <section className="py-16">
